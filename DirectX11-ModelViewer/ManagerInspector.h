	...
	for (int i = 0; i < NUM_OF_LIGHTS; i++)
	{
		...
		if (ImGui::CollapsingHeader(lightName.c_str(), ImGuiTreeNodeFlags_Framed))
		{
			if (ImGui::CollapsingHeader("Transform", ImGuiTreeNodeFlags_DefaultOpen | ImGuiTreeNodeFlags_Framed))
			{
				...
				ImGui::Checkbox("Enabled", (bool*)&currentLight->enabled);

				ImGui::Checkbox("Selected", (bool*)&currentLight->selected);
...
void ManagerInspector::RenderMaterialEdit()
{
	...
	{
		ImGui::Checkbox("HasAmbient", (bool*)&curMat->shaderUploadMaterial.hasAmbientTexture);
	...
	{
		ImGui::Checkbox("HasEmissive", (bool*)&curMat->shaderUploadMaterial.hasEmissiveTexture);
	...
	{
		ImGui::Checkbox("HasDiffuse", (bool*)&curMat->shaderUploadMaterial.hasDiffuseTexture);
	...
	{
		ImGui::Checkbox("HasSpecular", (bool*)&curMat->shaderUploadMaterial.hasSpecularTexture);
	...
	{
		ImGui::Checkbox("HasNormal", (bool*)&curMat->shaderUploadMaterial.hasNormalTexture);
	...
	{
		ImGui::Checkbox("HasBump", (bool*)&curMat->shaderUploadMaterial.hasBumpTexture);
	...
	{
		ImGui::Checkbox("HasOpacity", (bool*)&curMat->shaderUploadMaterial.hasOpacityTexture);
...
void ManagerInspector::RenderGameObjectList()
{
	...
	if (select == true)
	{
		activeEditGameObject = true;
		currentEditGameObjectKey = gameObjectNames[currentGameObjectNumber];
	}
