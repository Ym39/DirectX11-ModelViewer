...
SkinnedMeshShader::SkinnedMeshShader(const SkinnedMeshShader&)
{
}
...
bool SkinnedMeshShader::Initialize(ID3D11Device* device, HWND hwnd)
{
	bool result;
...
void SkinnedMeshShader::Shutdown()
{
	ShutdownShader();
...
bool SkinnedMeshShader::Render(ID3D11DeviceContext* deviceContext, int indexCount, XMMATRIX worldMatrix, XMMATRIX viewMatrix, XMMATRIX projectionMatrix, ID3D11ShaderResourceView* texture, XMFLOAT3 lightPosition, XMFLOAT4 diffuseColor, XMFLOAT4 ambientColor, XMFLOAT3 cameraPosition, XMFLOAT4 specularColor, float specularPower, const std::vector<XMMATRIX>& bones)
{
	bool result;
...
bool SkinnedMeshShader::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	HRESULT result;
...
void SkinnedMeshShader::ShutdownShader()
{
	if (mMatrixBuffer)
	{
...
void SkinnedMeshShader::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, WCHAR* shaderFilename)
{
	char* compileErrors;
...
bool SkinnedMeshShader::SetShaderParameters(ID3D11DeviceContext* deviceContext, XMMATRIX worldMatrix, XMMATRIX viewMatrix, XMMATRIX projectionMatrix, ID3D11ShaderResourceView* texture, XMFLOAT3 lightPosition, XMFLOAT4 diffuseColor, XMFLOAT4 ambientColor, XMFLOAT3 cameraPosition, XMFLOAT4 specularColor, float specularPower, const std::vector<XMMATRIX>& bones)
{
	HRESULT result;
...
void SkinnedMeshShader::RenderShader(ID3D11DeviceContext* deviceContext, int indexCount)
{
