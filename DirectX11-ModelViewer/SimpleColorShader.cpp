...
SimpleColorShader* gSimpleColorShader;
...
bool SimpleColorShader::Initialize(ID3D11Device* device, HWND hwnd)
{
	bool result;

	result = InitializeShader(device, hwnd, L"SimpleColorShader.hlsl", L"SimpleColorShader.hlsl");
	if (result == false)
	{
		return false;
	}
...
bool SimpleColorShader::Render(ID3D11DeviceContext* deviceContext, int indexCount, XMMATRIX worldMatrix, XMMATRIX viewMatrix, XMMATRIX projectionMatrix, XMFLOAT4 color)
{
	bool result;
...
bool SimpleColorShader::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	HRESULT result;
...
void SimpleColorShader::ShutdownShader()
{
	if (mMatrixBuffer)
	{
...
void SimpleColorShader::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, WCHAR* shaderFilename)
{
	char* compileErrors;
...
bool SimpleColorShader::SetShaderParameters(ID3D11DeviceContext* deviceContext, XMMATRIX worldMatrix, XMMATRIX viewMatrix, XMMATRIX projectionMatrix, XMFLOAT4 color)
{
	HRESULT result;
...
void SimpleColorShader::RenderShader(ID3D11DeviceContext* deviceContext, int indexCount)
{
